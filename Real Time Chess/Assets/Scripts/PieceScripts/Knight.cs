...
public class Knight : ChessPiece
{
    ...
    {
        Vector2 movement = isWhite ? InputController.Instance.p1KnightMove : InputController.Instance.p2KnightMove;
    ...
    public override void Fire(int playerNumber)
    {
        ...
        {
            Vector2 aim = playerNumber == 1 ? InputController.Instance.p1KnightAim : InputController.Instance.p2KnightAim;
            if (aim != Vector2.zero)
            {
