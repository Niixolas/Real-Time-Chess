...
namespace InControl
{
	...
	{
        // MB Modified to update deprecated function playmodeStateChanged to playModeStateChanged
		...
		{
			string versionPath = "Assets/Third Party/InControl/Assets/InControl/Source/VersionInfo.cs";
